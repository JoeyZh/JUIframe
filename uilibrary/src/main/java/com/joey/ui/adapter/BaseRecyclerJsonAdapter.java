...
public abstract class BaseRecyclerJsonAdapter<T, VH extends RecyclerView.ViewHolder> extends BaseModelRecyclerAdapter<T, VH> {
    ...
    public BaseRecyclerJsonAdapter(Context context, List<T> dataList, int layoutId, String from[], int to[]) {
        super(context, dataList, layoutId);
        create(from, to);
    }

    public BaseRecyclerJsonAdapter(Context context, List<T> dataList, int layout) {
